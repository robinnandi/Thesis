...
Silicon is used because of it produces fast, radiation hard electronics and good
resolution. \\
...
The transverse momentum resolution of the tracker is shown for muons of $p_{T} =
1, 10 and 100 \GeV$ in Figure \ref{fig:tracker_resolution}.

\begin{figure}
\includegraphics[width=\textwidth]{Tracker_Resolution.pdf}
\label{fig:tracker_resolution}
\caption{The layout of the s.}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{ECAL.pdf}
\end{center}
...
%In QCD dijet events, which have only fake missing tranvrese energy, the missing 
%transverse energy resolution is given by Equation \ref{eq:MET_Resolution}. 
%Severe mismeasurement of jets can also give fake missing transverse energy which
%contributes non-gaussian tails to the missing transverse energy resolution.
%
%\begin{equation}
...
%\end{equation}
%
%HCAL noise comes in three types:
%
%\begin{itemize}
%\item {\bf HPD noise:} Misallignment between the HPD electric field and the
%external magnetic field can lower the flashover voltage of the HPD resulting in
%occasional cascades where all or most of the 18 channels within the HPD report
%large energy deposits.
%\item {\bf RBX noise:} The source of this noise is not understood, but its
%behaviour is similar to HPD noise. In the case of RBX noise, all or most of the
%72 channels of an RBX report large energies.
%\item {\bf PMT Window noise:} Charged particles occasionally hit an HF PMT
%window directly instead of interacting with the quartz fibres. This results in a
%large energy deposit in either a long or a short fibre without an appreciable
%deposit in the other short/long partner.
%\end{itemize}
