...
\begin{figure}
\begin{center}
\includegraphics[width=0.6\textwidth]{particles2.png}
\end{center}
...
represented in the SM by the V-A structure of the weak interaction
...
This form of the potential is obtained by allowing the quadratic term to be
negative giving a non-zero vaccuum expectation value. There is a continuum of 
ground states giving equivalent physics, one of which must be chosen by nature. 
Choosing a particular ground state is known as symmetry breaking. Arbitrarily 
choose:
...
has previously been explored so one can expect to find new things. In the same
...
The SM particles and their SUSY partners form supermultiplets as in
Equation \ref{eq:supermultiplets}. Since the particles within the
supermultiplets must maintain the gauge symmetries of the SM, Q must 
...
are gauge particles. In the Minimal Supersymmetric SM (MSSM) there 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\textwidth]{susy_decay_chain.pdf}
\end{center}
...
The SM has been described with particular emphasis on the gauge
