...
onto the direction of motion) in the relativistic limit $m << E$. \\
...
\begin{equation}
L_{\mbox{Y}} = -y_{e}\bar{E}_{L}\phi e_{R} - y_{d}\bar{Q}_{L}\phi d_{R} -
y_{u}\bar{Q}_{L}\phi^{*} u_{R} + h.c.
\label{eq:yukawa}
\end{equation}
...
the LHC. Figure \ref{pdfs} shows the parton density functions measured by H1 and
ZEUS. \\
...
The coupling strength of the strong force varies with energy. Figure
\ref{fig:coupling} shows the variation in coupling strength of the strong, weak
and electromagnetic force as a function of energy. \\

\begin{figure}
\begin{center}
\includegraphics[width=0.8\textwidth]{coupling2.pdf}
\end{center}
\caption{The coupling strengths of the electromagnetic force, the weak force and
the strong force as a function of energy.}
\label{fig:coupling}
\end{figure}

The strong force is strong at low energies where quarks exist only in colourless 
bound states. This is known as confinement. At high energies the strong force
becomes weaker as the partons behave as free particles. This is known as
asymptotic freedom.  
