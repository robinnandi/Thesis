...
QED has been tested to very high precision. The magnetic moment of the
electron, $-\frac{g\mu_{B}S}{h}$, has $g = 2$ according to Dirac's theory, 
however QED predicts quantum corrections which give: 

\begin{equation}
g - 2 = 0.00115965218073(28)
\end{equation}

Precision measurements have tested QED to be accurate to 1 part in $10^{9}$.
...
symmetry ensures cancellation of the divergence in the Higgs boson mass. The 
operator Q which generates the supersymmetric transformations can be written as 
