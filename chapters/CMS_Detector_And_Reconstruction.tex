...
Level 1 consists of on-detector hardware and the goal is to reduce the rate to 
$\sim 10\unit{kHz}$ to satisfy the constraint set by the DAQ bandwidth. The HLT 
...
to further reduce the rate to $\sim 100\unit{Hz}$ to satisfy the constraint set 
by the storage and reconstruction facilities.
