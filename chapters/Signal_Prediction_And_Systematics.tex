...
$\HT$ distribution (Figure \ref{fig:meanht_vs_htshift}). Figure \ref{fig:puHT} 
shows the $\HT$ distribution with a $\pm 1$ sigma variation in the shift. The
important number is how this affects the signal efficiency in the
($\HT>700\unit{GeV}$, $\MET>200\unit{GeV}$) bin. With a $\pm1\sigma$ variation
...
distribution with pile-up. Figure \ref{fig:meanmet_vs_metsmearing} shows the 
...
account for pile-up. Figure \ref{fig:puMET} shows the $\MET$ distribution with a 
$\pm 1$ sigma variation in the shift. The important number is the uncertainty in
