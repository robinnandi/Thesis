...
2000 $\GeV$ in intervals of 80 $\GeV$. The cross section is x-y pb depending on 
the parameter values. The largest uncertainty in the signal prediction comes 
from the cross section (10--60\%). \\
...
efficiency correction for the differences between data and MC and from pile-up
which affects the photon isolation efficiency. Both the $\HT$ and $\MET$ 
distributions are also affected by pile-up, but this is a small effect.
