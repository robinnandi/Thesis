...
Pile-up is where there are multiple interations per bunch crossing. Some of the
...
pile-up. A shift of $x$ is applied to the no pile-up $\HT$ distribution 
to match the pile-up $\HT$ distribution. Figure \ref{fig:puHT} shows the $\HT$ 
distribution with a $\pm 1$ sigma variation in the shift. \\
